...
<header> 
          ...
          <nav>   
                ...
                <a class='anis' href=<?php echo(URL."/rdvconfirmer.php")  ?>> Rendez-vous confirmés  </a>
...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    <a href=<?php echo(URL."/rdvconfirmer.php")?>>tout</a>
    <a  href=<?php echo(URL."/rdvconfirmer.php?type='IRM'")?>>IRM</a>
    <a  href=<?php echo(URL."/rdvconfirmer.php?type='Mamographie'")?>>Mamographie</a>
    <a  href=<?php echo(URL."/rdvconfirmer.php?type='Radio'")?>>Radio</a>
  </div>
</div> 
...
<table  border cellspacing=10 cellpadding=10 >
    <?php
    //connection et reccuperation des rendez-vous confirmer de la basse de données
     try
        {
...
$sql="SELECT id,nom,prenom,telephone,email,date_n,examen,dat,heure,valide FROM rdv where dat>=CURDATE() and valide =1 and examen=$t ORDER BY id asc ";
    ...
    <tr>
       ...
       <?php if($t==''){?>
        <td><a href="includes/supprimer.php?id=<?php echo $line['id']; ?>&url=rdvconfirmer.php " > Supprimer  </a></td>
    <?php }else{ ?>
    <td><a href="includes/supprimer.php?id=<?php echo $line['id']; ?>&url=rdvconfirmer.php?type=<?php echo $t; ?> " > Supprimer  </a></td><?php  }?>
    </tr>
    <?php }}   ?>
